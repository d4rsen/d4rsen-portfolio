        ...
        <div id="jobs" className="mainPage__jobs jobs">
            ...
            <div className="jobs__inner ">
                <div className="jobs__left">
                    <JobsButton jobs={jobs} setJobs={setJobs} text="Elbrus" active={jobs.elbrus} />
                    <JobsButton jobs={jobs} setJobs={setJobs} text="ABT" active={jobs.abt} />
                    <JobsButton jobs={jobs} setJobs={setJobs} text="Home" active={jobs.home} />
                </div>
                <div className="jobs__right">{jobs.abt ? <Abt /> : jobs.elbrus ? <Elbrus /> : <Home />}</div>
            </div>
        </div>
    );
}
