    ...
    return (
        <>
            <div className="jobs__title title">
                ...
                <span className="title__company">{" Elbrus"}</span>
            </div>
            <div className="jobs__subtitle">Sep 2021 - Jan 2022</div>
            ...
            <SkillsItem text="Developed  the server part of the application with Node.js (express)" />
